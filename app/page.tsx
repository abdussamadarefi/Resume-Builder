        ...
        <section className="relative z-10 w-full max-w-7xl mx-auto px-6 flex-1 flex flex-col lg:flex-row items-center justify-center gap-16 py-12 md:py-24">
          ...
          >
            ...
            <motion.h1 
              ...
              className="text-4xl sm:text-5xl md:text-6xl font-heading font-extrabold tracking-tight text-slate-900 dark:text-white leading-[1.08] lg:leading-[1.05]"
            >
            ...
            <div className="relative bg-white/90 dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800/80 rounded-3xl p-6 shadow-2xl backdrop-blur-xl transition-colors duration-200">
              ...
              <div className="flex flex-col gap-4 mb-6 pb-4 border-b border-slate-200 dark:border-slate-800">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-[9px] px-2 py-0.5 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 rounded-md font-bold uppercase tabular-nums">100% Vector</span>
                </div>
                  ...
                  <div className="flex gap-1.5 bg-slate-100 dark:bg-slate-950 p-1 rounded-xl border border-slate-200 dark:border-slate-800">
                    {(["nexus", "scholar", "arya"] as MockTemplate[]).map((t) => (
                      <button
                        ...
                        className={cn(
                          "text-[10px] font-bold uppercase tracking-wider px-2.5 py-1.5 rounded-lg transition-all",
              ...
              <div className="bg-white rounded-xl shadow-inner p-5 aspect-[1/1.25] text-slate-800 transition-all duration-300 flex flex-col justify-between select-none border border-slate-100 overflow-hidden">
                    ...
                    {mockTemplate === "nexus" && (
                      <div className="flex-1 flex flex-col font-sans">
                        <div className="text-center mb-3">
                          <div className="text-xs font-bold tracking-tight uppercase" style={{ color: mockColors[mockColor].hex }}>
                            Eleanor Vance, Ph.D.
                          </div>
                          ...
                          <div className="text-[8px] text-slate-400 mt-1 flex justify-center gap-1.5 font-medium">
                        ...
                        <div className="mb-2 text-[8px] text-slate-600 text-center italic leading-relaxed">
                        ...
                        <div className="grid grid-cols-3 gap-3 flex-1">
                          <div className="col-span-2 space-y-2">
                            <div>
                              <div className="text-[9px] font-bold uppercase tracking-wider pb-0.5 border-b" style={{ borderColor: mockColors[mockColor].hex }}>
                                Professional Experience
                              </div>
                              <div className="mt-1 space-y-1">
                                <div>
                                  <div className="text-[8px] font-bold text-slate-900 flex justify-between">
                                    <span>Staff Physicist</span>
                                    <span className="text-[7px] text-slate-400 tabular-nums">2022 – PRES</span>
                                  </div>
                                  <div className="text-[7px] text-slate-400 font-bold uppercase">Quantum Labs Inc.</div>
                                  <div className="text-[7.5px] text-slate-600 mt-0.5 leading-snug">
                          ...
                          <div className="space-y-2">
                            <div>
                              ...
                              <div className="mt-1 space-y-1">
                                <div>
                                  <div className="text-[8px] font-bold text-slate-900">Ph.D. in Physics</div>
                                  <div className="text-[7px] text-slate-500 leading-tight">Harvard University</div>
                                </div>
                              </div>
                            </div>
                          </div>
                    ...
                    {mockTemplate === "scholar" && (
                      <div className="flex-1 flex flex-col font-serif">
                        <div className="border-b-2 pb-2 mb-2" style={{ borderColor: mockColors[mockColor].hex }}>
                          <div className="text-sm font-bold text-slate-900 tracking-wide text-center">
                            Dr. Eleanor Vance
                          </div>
                          <div className="text-[8px] text-slate-600 text-center tracking-wider uppercase mt-0.5">
                        ...
                        <div className="flex-1 space-y-2">
                          <div>
                            <div className="text-[8.5px] font-bold uppercase tracking-wider text-slate-800 border-b border-slate-200 pb-0.5">
                              Peer-Reviewed Publications
                            </div>
                            <div className="mt-1 space-y-1 text-[7.5px] text-slate-700 leading-relaxed">
                              <p><span className="font-bold text-slate-900">Vance, E.</span>, et al. (2024). &ldquo;Coherent control of fluxonium qubits.&rdquo; <span className="italic font-serif">Nature Physics</span>, 20(4), 412–418.</p>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    {mockTemplate === "arya" && (
                      <div className="flex-1 flex font-sans -m-5">
                        <div className="w-[32%] p-3 text-white flex flex-col justify-between" style={{ backgroundColor: mockColors[mockColor].hex }}>
                          <div className="space-y-2">
                            <div>
                              <div className="text-[10px] font-bold uppercase tracking-tight">Eleanor Vance</div>
                              <div className="text-[7px] opacity-80 uppercase tracking-widest mt-0.5">Physicist</div>
                            </div>
                          </div>
                        </div>

                        <div className="w-[68%] p-3 bg-white flex flex-col justify-start space-y-2">
                          <div>
                            <div className="text-[8.5px] font-bold uppercase tracking-wider pb-0.5 border-b text-slate-500" style={{ color: mockColors[mockColor].hex }}>
                              Professional Experience
                            </div>
                            <div className="mt-1 space-y-1">
                              <div>
                                ...
                                <div className="text-[7px] text-slate-500 font-bold uppercase">QuantumLabs</div>
                              </div>
                            </div>
                          </div>
                        </div>
                ...
                {/* Bottom tag bar */}
                <div className="mt-3 pt-2 border-t border-slate-100 flex items-center justify-between text-[8px] text-slate-400 font-bold uppercase tracking-wider">
        ...
        <section className="relative z-10 w-full max-w-7xl mx-auto px-6 py-16 md:py-28 border-t border-slate-200 dark:border-slate-900/60">
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-4">
            ...
            >
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-heading font-extrabold text-slate-900 dark:text-white tracking-tight mt-4">
