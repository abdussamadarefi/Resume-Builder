...
export default function PrivacyPageClient() {
  const { badge, title, subtitle, last_updated, tldr_headline, tldr_content, sections } = privacyData
  ...
  return (
    <LandingLayout>
      <div className="w-full max-w-4xl mx-auto px-6 py-16 md:py-24">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-600 dark:text-emerald-400 text-[10px] font-bold uppercase tracking-wider">
        ...
        {tldr_content && (
          <motion.div
            ...
            className="p-6 md:p-8 rounded-3xl bg-white/90 dark:bg-slate-900/40 border border-emerald-500/30 dark:border-emerald-500/20 mb-12 space-y-3 shadow-sm dark:shadow-none"
          >
