...
export default function TermsPageClient() {
  const { badge, title, subtitle, last_updated, tldr_headline, tldr_content, sections } = termsData
      ...
      <div className="w-full max-w-4xl mx-auto px-6 py-16 md:py-24">
        ...
        {tldr_content && (
          <motion.div
            ...
            className="p-6 md:p-8 rounded-3xl bg-white/90 dark:bg-slate-900/40 border border-blue-500/30 dark:border-blue-500/20 mb-12 space-y-3 shadow-sm dark:shadow-none"
          >
            <div className="flex items-center gap-2 text-blue-600 dark:text-blue-400 font-bold text-sm">
              <Scale size={18} />
              <span>{tldr_headline || "Plain-English Summary"}</span>
            </div>
