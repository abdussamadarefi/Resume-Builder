    ...
    <>
      <header
        className={cn(
          ...
          scrolled
            ? "bg-[#030712]/80 backdrop-blur-xl border-b border-slate-800/60 shadow-lg shadow-black/10"
            : "bg-transparent"
        )}
      >
        <div className="w-full max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            >
              Launch Builder <ArrowRight size={14} className="group-hover:translate-x-0.5 transition-transform" />
            </Link>
          </div>
          ...
          <button
            ...
            className="md:hidden p-2 rounded-lg text-slate-400 hover:text-white hover:bg-slate-900/60 transition-colors"
        ...
        {mobileOpen && (
          <>
            ...
            <motion.div
              ...
              exit={{ x: "100%" }}
              transition={{ type: "spring", stiffness: 300, damping: 30 }}
              className="fixed top-0 right-0 bottom-0 z-50 w-[280px] bg-[#0a0f1a] border-l border-slate-800 p-6 flex flex-col md:hidden"
            >
              ...
              <div className="mt-auto space-y-3 pt-6 border-t border-slate-800">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 px-4 py-3 rounded-xl text-slate-400 hover:text-white hover:bg-slate-900/40 text-sm font-semibold transition-colors"
                >
